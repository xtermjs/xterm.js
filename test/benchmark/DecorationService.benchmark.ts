...
import { DecorationService } from '../../out/common/services/DecorationService';
import { MockLogService, MockBufferService, MockOptionsService } from '../../out/common/TestUtils.test';
