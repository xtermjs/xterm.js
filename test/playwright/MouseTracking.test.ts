 ...
 */
test.describe('Mouse Tracking Tests', async () => {
// TODO: None of these tests run at the moment
  const itMouse = isChromium ? test : test.skip;
