...
import { Terminal, ITerminalAddon, IUnicodeVersionProvider } from 'xterm';
 ...
 */
function fill<T extends TypedArray>(array: T, value: number, start?: number, end?: number): T {
...
function fillFallback<T extends TypedArray>(array: T, value: number, start: number = 0, end: number = array.length): T {
  // safari and IE 11
...
class UnicodeV11 implements IUnicodeVersionProvider {
  ...
  constructor() {
    if (!UnicodeV11.bmpTable) {
      UnicodeV11.bmpTable = new Uint8Array(65536);
      fill(UnicodeV11.bmpTable, 1);
      UnicodeV11.bmpTable[0] = 0;
      fill(UnicodeV11.bmpTable, 0, 1, 32);
      fill(UnicodeV11.bmpTable, 0, 0x7f, 0xa0);
      for (let r = 0; r < UnicodeV11.bmpCombining.length; ++r) {
        fill(UnicodeV11.bmpTable, 0, UnicodeV11.bmpCombining[r][0], UnicodeV11.bmpCombining[r][1] + 1);
      }
      for (let r = 0; r < UnicodeV11.bmpWide.length; ++r) {
        fill(UnicodeV11.bmpTable, 2, UnicodeV11.bmpWide[r][0], UnicodeV11.bmpWide[r][1] + 1);
      }
    }
  }
