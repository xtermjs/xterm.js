...
import { AltMouseCursorController, MouseEventCssClasses, MouseService } from 'target-browser/services/MouseService';
...
import { MockCoreBrowserService, MockRenderService, MockSelectionService } from 'target-browser/TestUtils.test';
