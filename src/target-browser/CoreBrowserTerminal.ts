...
import { copyHandler, handlePasteEvent, moveTextAreaUnderMouseCursor, paste, rightClickHandler } from 'target-browser/Clipboard';
import * as Strings from 'target-browser/LocalizableStrings';
import { OscLinkProvider } from 'target-browser/OscLinkProvider';
import { CharacterJoinerHandler, CustomKeyEventHandler, CustomWheelEventHandler, IBrowser, IBufferRange, ICompositionHelper, ILinkifier2, ITerminal } from 'target-browser/Types';
import { Viewport } from 'target-browser/Viewport';
import { BufferDecorationRenderer } from 'target-browser/decorations/BufferDecorationRenderer';
import { OverviewRulerRenderer } from 'target-browser/decorations/OverviewRulerRenderer';
import { CompositionHelper } from 'target-browser/input/CompositionHelper';
import { DomRenderer } from 'target-browser/renderer/dom/DomRenderer';
import { IRenderer } from 'target-browser/renderer/shared/Types';
import { CharSizeService } from 'target-browser/services/CharSizeService';
import { CharacterJoinerService } from 'target-browser/services/CharacterJoinerService';
import { CoreBrowserService } from 'target-browser/services/CoreBrowserService';
import { LinkProviderService } from 'target-browser/services/LinkProviderService';
import { MouseCoordsService } from 'target-browser/services/MouseCoordsService';
import { MouseEventCssClasses, MouseService } from 'target-browser/services/MouseService';
import { RenderService } from 'target-browser/services/RenderService';
import { SelectionService } from 'target-browser/services/SelectionService';
import { ICharSizeService, ICharacterJoinerService, ICoreBrowserService, IKeyboardService, ILinkProviderService, IMouseCoordsService, IMouseService, IRenderService, ISelectionService, IThemeService } from 'target-browser/services/Services';
import { ThemeService } from 'target-browser/services/ThemeService';
import { KeyboardService } from 'target-browser/services/KeyboardService';
