...
export interface IInputHandler {
  ...
  /** CSI @ */ insertChars(params?: number[], collect?: string): void;
  /** CSI A */ cursorUp(params?: number[], collect?: string): void;
  /** CSI B */ cursorDown(params?: number[], collect?: string): void;
  /** CSI C */ cursorForward(params?: number[], collect?: string): void;
  /** CSI D */ cursorBackward(params?: number[], collect?: string): void;
  /** CSI E */ cursorNextLine(params?: number[], collect?: string): void;
  /** CSI F */ cursorPrecedingLine(params?: number[], collect?: string): void;
  /** CSI G */ cursorCharAbsolute(params?: number[], collect?: string): void;
  /** CSI H */ cursorPosition(params?: number[], collect?: string): void;
  /** CSI I */ cursorForwardTab(params?: number[], collect?: string): void;
  /** CSI J */ eraseInDisplay(params?: number[], collect?: string): void;
  /** CSI K */ eraseInLine(params?: number[], collect?: string): void;
  /** CSI L */ insertLines(params?: number[], collect?: string): void;
  /** CSI M */ deleteLines(params?: number[], collect?: string): void;
  /** CSI P */ deleteChars(params?: number[], collect?: string): void;
  /** CSI S */ scrollUp(params?: number[], collect?: string): void;
  /** CSI T */ scrollDown(params?: number[], collect?: string): void;
  /** CSI X */ eraseChars(params?: number[], collect?: string): void;
  /** CSI Z */ cursorBackwardTab(params?: number[], collect?: string): void;
  /** CSI ` */ charPosAbsolute(params?: number[], collect?: string): void;
  /** CSI a */ HPositionRelative(params?: number[], collect?: string): void;
  /** CSI b */ repeatPrecedingCharacter(params?: number[], collect?: string): void;
  /** CSI c */ sendDeviceAttributes(params?: number[], collect?: string): void;
  /** CSI d */ linePosAbsolute(params?: number[], collect?: string): void;
  /** CSI e */ VPositionRelative(params?: number[], collect?: string): void;
  /** CSI f */ HVPosition(params?: number[], collect?: string): void;
  /** CSI g */ tabClear(params?: number[], collect?: string): void;
  /** CSI h */ setMode(params?: number[], collect?: string): void;
  /** CSI l */ resetMode(params?: number[], collect?: string): void;
  /** CSI m */ charAttributes(params?: number[], collect?: string): void;
