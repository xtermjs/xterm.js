...
import { IInputHandlingTerminal, IViewport, ICompositionHelper, ITerminal, IBuffer, IBufferSet, IBrowser, ICharMeasure, ISelectionManager, ITerminalOptions, ILinkifier, IMouseHelper, ILinkMatcherOptions, CharacterJoinerHandler, IBufferLine, IBufferStringIterator, IUnicodeVersionManager } from '../Types';
...
export class MockTerminal implements ITerminal {
  ...
  unicodeManager: IUnicodeVersionManager = new UnicodeVersionManager();
}
