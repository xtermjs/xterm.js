...
export class Viewport {
  ...
  private charMeasureElement: any;
  private currentRowHeight: any;
  private lastRecordedBufferLength: any;
  private lastRecordedViewportHeight: any;
  private isApplicationMode: any;
   ...
   *   the terminal.
   */
  constructor(terminal, viewportElement, scrollArea, charMeasureElement) {
   ...
   */
  public setApplicationMode(isApplicationMode) {
