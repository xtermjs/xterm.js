...
import { IKeyboardEvent, KeyboardResultType, ICharset, IBufferLine, IAttributeData, CoreMouseEventType, CoreMouseButton, CoreMouseAction, IEncoding } from 'common/Types';
...
export class Terminal extends Disposable implements ITerminal, IDisposable, IInputHandlingTerminal {
  ...
  constructor(
    ...
    this._ioService = this._instantiationService.createInstance(IoService, (data: Uint32Array, length: number) => this._inputHandler.parse(data, length));
  ...
  public bindMouse(): void {
    ...
    this._coreMouseService.onProtocolChange((events: CoreMouseEventType) => {
