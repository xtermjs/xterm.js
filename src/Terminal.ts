...
/** define may be declared externally */
declare var define;
...
export class Terminal extends EventEmitter implements ITerminal {
  ...
  private refreshRowsQueue: any[];

  private cursorState: number;
  private cursorHidden: boolean;
  private convertEol: any;
  private queue: string;
  private scrollTop: number;
  private scrollBottom: number;
  private customKeydownHandler: Function;
  ...
  private wraparoundMode: boolean;
  private normal: any;

  // charset
  private charset: any;
  private gcharset: any;
  private glevel: any;
  private charsets: any;

  // mouse properties
  private decLocator: any;
  private x10Mouse: any;
  private vt200Mouse: any;
  private vt300Mouse: any;
  private normalMouse: any;
  private mouseEvents: any;
  private sendFocus: any;
  private utfMouse: any;
  private sgrMouse: any;
  private urxvtMouse: any;

  // misc
  private children: any;
  private refreshStart: any;
  private refreshEnd: any;
  private savedX: any;
  private savedY: any;
  private savedCols: any;
  ...
  private writeInProgress: any;
  private refreshFramesSkipped: any;

  private xoffSentToCatchUp: any;
  private writeStopped: any;
  private surrogate_high: any;
  private tabs: any;
  private userScrolling: any;

  private viewportElement: HTMLElement;
  private viewportScrollArea: HTMLElement;
  private compositionView: HTMLElement;
  private helperContainer: HTMLElement;
  private charSizeStyleElement: HTMLElement;
   ...
   */
  public insertRow(row?: HTMLElement) {
    if (!row) {
  ...
  public open(parent) {
    ...
    this.element.classList.add('xterm-theme-' + this.options.theme);
  ...
  public destroy() {
    this.readable = false;
    this.writable = false;
    // TODO: Expose destroy/dispose method on EventEmitter
    (<any>this)._events = {};
   ...
   */
  private queueRefresh(start: number, end: number) {
   ...
   * viewport originally.
   */
  public scrollDisp(disp: number, suppressScrollEvent?: boolean) {
    if (disp < 0) {
   ...
   */
  public attachCustomKeydownHandler(customKeydownHandler: (event: KeyboardEvent) => boolean) {
   ...
   */
  public evaluateKeyEscapeSequence(ev) {
    const result = {
   ...
   */
  public eraseRight(x: number, y: number) {
   ...
   */
  public is(term) {
    let name = this.options.termName;
