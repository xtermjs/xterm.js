...
export class Terminal extends EventEmitter implements ITerminal, IDisposable, IInputHandlingTerminal {
  ...
  public mouseEventsHandler: MouseEventsHandler;
  ...
  private _setup(): void {
    ...
    this.mouseEventsHandler = this.mouseEventsHandler || new MouseEventsHandler(this);
  ...
  public open(parent: HTMLElement): void {
    ...
    this.mouseEventsHandler.bindMouse();
