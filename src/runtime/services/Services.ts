...
import { CoreMouseEncoding, CoreMouseEventType, CursorInactiveStyle, CursorStyle, ICharset, IColor, ICoreMouseEvent, ICoreMouseProtocol, IDecPrivateModes, IDisposable, IKittyKeyboardState, IModes, IOscLinkData, IWindowOptions } from 'common/Types';
...
import type { IBufferService as IBufferServiceModel, IBufferResizeEvent as IBufferResizeEventModel } from 'common/buffer/BufferService';
export type IBufferService = IBufferServiceModel;
export type IBufferResizeEvent = IBufferResizeEventModel;
export const IBufferService = createDecorator<IBufferServiceModel>('BufferService');
