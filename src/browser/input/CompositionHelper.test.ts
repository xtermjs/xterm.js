...
describe('CompositionHelper', () => {
  ...
  beforeEach(() => {
    ...
    compositionHelper = new CompositionHelper(textarea, compositionView, bufferService, new MockOptionsService(), coreService, new MockRenderService(), new DirectionService());
  });
