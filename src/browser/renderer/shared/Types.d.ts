...
export interface ITextureAtlas extends IDisposable {
   ...
   */
  clearTexture(): void;
  getRasterizedGlyph(code: number, bg: number, fg: number, ext: number, variant: number, restrictToCellHeight: boolean): IRasterizedGlyph;
  getRasterizedGlyphCombinedChar(chars: string, bg: number, fg: number, ext: number, variant: number, restrictToCellHeight: boolean): IRasterizedGlyph;
}
