...
import { channels, color, rgb } from 'common/services/Color';
import { CoreTerminal } from 'common/terminal/CoreTerminal';
import * as Browser from 'common/base/Platform';
import { ColorRequestType, IColorEvent, ITerminalOptions, KeyboardResultType, SpecialColorIndex } from 'common/services/Types';
...
import { WindowsOptionsReportType } from '../common/terminal/InputHandler';
import { AccessibilityManager } from './AccessibilityManager';
import { Linkifier } from './Linkifier';
import { Emitter, EventUtils, type IEvent } from 'common/base/Event';
import { addDisposableListener } from 'browser/Dom';
import { MutableDisposable, toDisposable } from 'common/base/Lifecycle';
