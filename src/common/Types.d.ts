...
import { ClipboardSelectionType as ClipboardSelectionType, IFunctionIdentifier, ITerminalOptions as IPublicTerminalOptions } from '@xterm/xterm';
...
export const enum ClipboardEventType {
  REPORT = 0,
  SET = 1
}
...
export interface IInputHandler {
  ...
  /** OSC 52 */ setOrReportClipboard(data: string): boolean;
