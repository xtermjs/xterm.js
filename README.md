...
- [**NgTerminal**](https://github.com/qwefgh90/ng-terminal): NgTerminal is web terminal to provide some features including xtermjs on Angular7 or higher. You can easily add it into your application by adding `<ng-terminal></ng-terminal>` into your component.
