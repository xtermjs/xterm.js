...
- [**StandTerm**](https://github.com/askac/standterm): Local-first browser terminal for SSH, host-local shells, and UART sessions, with controlled external-agent access. Its terminal tabs use xterm.js with the Fit, WebGL, Web Links, and Unicode 11 addons.
